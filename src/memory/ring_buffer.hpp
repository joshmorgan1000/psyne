...
public:
    ...
    uint8_t* base_ptr() noexcept override { return slab_; }
    const uint8_t* base_ptr() const noexcept override { return slab_; }
    ...
    size_t write_position() const noexcept override { return head_; }
    size_t read_position() const noexcept override { return tail_; }
    bool has_space(size_t size) const noexcept override;
    size_t capacity() const noexcept override { return buffer_size_; }
...
public:
    ...
    size_t write_position() const override { return head_.load(std::memory_order_acquire); }
    size_t read_position() const override { return tail_; }
    bool has_space(size_t size) const override;
    size_t capacity() const override { return buffer_size_; }
...
public:
    ...
    size_t write_position() const override { return head_; }
    size_t read_position() const override { return tail_.load(std::memory_order_acquire); }
    bool has_space(size_t size) const override;
    size_t capacity() const override { return buffer_size_; }
