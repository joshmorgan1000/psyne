...
// This file should be included by source files that need the template implementations
...
template<typename MessageType>
std::unique_ptr<std::thread> Channel::listen(std::function<void(MessageType&&)> handler) {
