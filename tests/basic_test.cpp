...
void test_memory_channel() {
    ...
    auto channel_ptr = Channel::create(
        "memory://test", 64 * 1024, ChannelMode::SPSC, ChannelType::SingleType);
...
void test_channel_factory() {
    ...
    auto channel = ChannelFactory::create<SPSCRingBuffer>(
        "memory://factory_test", 64 * 1024, ChannelType::SingleType);
...
void test_producer_consumer() {
    ...
    auto channel_ptr =
        Channel::create("memory://pc_test", 64 * 1024, ChannelMode::SPSC,
