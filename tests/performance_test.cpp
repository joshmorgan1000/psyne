...
int main() {
    ...
    try {
        // Test 1: Performance Manager
        {
            ...
            std::cout << "✓ Performance Manager creation and summary"
                      << std::endl;
        }
        ...
        {
            auto channel =
                psyne::create_channel("memory://reliability_test", 1024 * 1024);
            ...
            std::cout << "✓ Reliability Manager lifecycle and components"
                      << std::endl;
        }

        // Test 3: Benchmark functionality
        {
            auto channel = psyne::create_channel("memory://benchmark_test",
                                                 2 * 1024 * 1024);
            auto &perf_manager = psyne::PerformanceManager::instance();
        ...
        {
            auto channel = psyne::create_channel("memory://optimization_test",
                                                 1024 * 1024);
            auto &perf_manager = psyne::PerformanceManager::instance();
        ...
        {
            auto channel =
                psyne::create_channel("memory://guard_test", 1024 * 1024);
            ...
            auto reliable_channel = psyne::create_reliable_channel(
                "memory://guard_test", 1024 * 1024, psyne::ChannelMode::SPSC,
                config);
        ...
        // Test 6: Version information
        {
            ...
            std::cout << "✓ Version information correct: " << version
                      << std::endl;
        }

        std::cout << "All Performance and Reliability Tests Passed! ✅"
                  << std::endl;
        return 0;
