...
int main() {
    ...
    try {
        ...
        {
            auto channel =
                psyne::create_channel("memory://test_channel", 1024 * 1024);
        ...
        // Test 3: Unix socket channel
        {
            auto channel = psyne::create_channel(
                "unix:///tmp/psyne_test_socket", 256 * 1024);
            assert(channel != nullptr);
        ...
        {
            auto channel = psyne::create_channel(
                "memory://mode_test", 1024 * 1024, psyne::ChannelMode::SPSC,
        ...
        {
            auto channel = psyne::create_channel(
                "memory://multi_type", 1024 * 1024, psyne::ChannelMode::MPMC,
        ...
        {
            auto channel1 =
                psyne::create_channel("memory://reuse_test", 1024 * 1024);
            auto channel2 =
                psyne::create_channel("memory://reuse_test", 1024 * 1024);
