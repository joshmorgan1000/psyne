...
int main() {
    try {
        ...
        auto channel = create_channel("memory://metrics_test", 1024*1024, 
        ...
        if (channel->has_metrics()) {
            ...
            std::cout << "  Receive blocks: " << metrics.receive_blocks << std::endl;
        }
        ...
        if (channel->has_metrics()) {
            ...
            std::cout << "  Messages sent: " << reset_metrics.messages_sent << std::endl;
            std::cout << "  Messages received: " << reset_metrics.messages_received << std::endl;
        }
