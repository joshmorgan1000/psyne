...
public:
    ...
    void transport_send(void* data, size_t size) override {
        std::cout << "DemoSubstrate: Sending " << size << " bytes via transport\n";
    ...
    void transport_receive(void* buffer, size_t buffer_size) override {
        std::cout << "DemoSubstrate: Ready to receive up to " << buffer_size << " bytes\n";
    }
    
    const char* substrate_name() const override { return "DemoSubstrate"; }
...
public:
    void* coordinate_allocation(void* slab_memory, size_t message_size) override {
        ...
        std::cout << "DemoPattern: Coordinating allocation #" << allocation_count_ 
                  << " at offset " << offset << "\n";
    ...
    const char* pattern_name() const override { return "DemoPattern"; }
...
void demonstrate_behaviors() {
    ...
    psyne::behaviors::ChannelBridge<SimpleMessage, DemoSubstrate, DemoPattern> channel(1024);
    ...
    // Message 1: Default construction
    {
        ...
        std::cout << "   Message data: ID=" << msg1->id << ", Value=" << msg1->value 
                  << ", Data='" << msg1->data << "'\n";
    ...
    // Message 2: Construction with arguments
    {
        ...
        std::cout << "   Message data: ID=" << msg2->id << ", Value=" << msg2->value 
                  << ", Data='" << msg2->data << "'\n";
    ...
    // Message 3: Another message to show pattern coordination
    {
        ...
        std::cout << "   Message data: ID=" << msg3->id << ", Value=" << msg3->value 
                  << ", Data='" << msg3->data << "'\n";
    ...
    if (!received) {
        std::cout << "   No messages available (pattern coordination returned nullptr)\n";
    }
...
int main() {
    ...
    try {
        ...
        std::cout << "• Messages are lenses that provide typed access to substrate memory\n";
        std::cout << "• Patterns coordinate producer/consumer access and synchronization\n";
        ...
        std::cout << "• GPU vendors can implement device-specific memory management\n";
        std::cout << "• Pattern developers can create new coordination algorithms\n";
