...
public:
     ...
     */
    MTL::Buffer* metal_buffer() const { return buffer_; }
...
public:
    ...
    bool supports_unified_memory() const override { return true; }
    size_t max_buffer_size() const override;
    
private:
    MTL::Device* device_;
    
    MTL::ResourceOptions get_resource_options(BufferUsage usage, MemoryAccess access) const;
};
...
public:
     ...
     */
    MTL::ComputePipelineState* create_compute_pipeline(const std::string& function_name);
    
    /**
     * @brief Load default Metal library
     */
    MTL::Library* default_library() const { return default_library_; }
...
public:
    ...
    MTL::CommandBuffer* get() const { return buffer_; }
