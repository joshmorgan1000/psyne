...
public:
    explicit MPMC(size_t max_messages = 1024 * 1024) : max_messages_(max_messages) {}
    ...
    bool needs_locks() const override { return true; } // For both producer and consumer coordination
     ...
     */
    size_t get_allocation_failures() const { return allocation_failures_.load(); }
    size_t get_receive_failures() const { return receive_failures_.load(); }
