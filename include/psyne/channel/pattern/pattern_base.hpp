 ...
 * All patterns support allocation, sync/async receive, and producer/consumer
 * management.
 */
...
public:
     ...
     */
    virtual boost::asio::awaitable<T *>
     ...
     */
    virtual T *receive_blocking(std::chrono::milliseconds timeout =
                                    std::chrono::milliseconds(1000)) = 0;
     ...
     */
    virtual size_t register_producer() {
        return 0;
    }
    virtual size_t register_consumer() {
        return 0;
    }
